...
from concurrent.futures import ThreadPoolExecutor as sadikssb
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :             MD:SADIK
\033[1;37m Facebook:           MD:SADIK
\033[1;37m Github  :            SADIK-999
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sadikssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    sadik = input('Saving Put File Name :')
    os.system('touch ' +sadik)
    os.system('sort -r '+ssb+' | uniq > '+sadik)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + sadik )
    print(47*'-')
